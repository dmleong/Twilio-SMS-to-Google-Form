...
from formurlvalidator import FormUrlValidator, ValidationFailureReason
...
def submit():
    ...
    try:
        ...
        form = FormUrlValidator(request.form['url'])
...
if __name__ == "__main__":
    # Bind to PORT if defined, otherwise default to 5555.
    import os
